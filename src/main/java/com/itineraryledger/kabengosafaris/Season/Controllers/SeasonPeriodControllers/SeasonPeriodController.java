...
public class SeasonPeriodController {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.itineraryledger.kabengosafaris.Season.Repositories.SeasonPeriodRepository bulkFlagsRepository;
    ...
    public ResponseEntity<?> bulkFlags(
        ...
        return bulkFlags.apply("season period", bulkFlagsRepository, request, entity -> {
