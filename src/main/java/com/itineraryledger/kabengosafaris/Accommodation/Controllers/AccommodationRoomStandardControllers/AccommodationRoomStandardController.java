...
public class AccommodationRoomStandardController {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.itineraryledger.kabengosafaris.Accommodation.Repositories.AccommodationRoomStandardRepository bulkFlagsRepository;
    ...
    public ResponseEntity<?> bulkFlags(
        ...
        return bulkFlags.apply("room standard", bulkFlagsRepository, request, entity -> {
