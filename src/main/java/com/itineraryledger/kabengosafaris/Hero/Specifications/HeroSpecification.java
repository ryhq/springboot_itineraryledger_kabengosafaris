...
public class HeroSpecification {
     ...
     *
     * Title, subtitle, description and the button's own text — somebody looking for the
     * banner that says "Book your safari" is as likely to remember the button as the
     * heading.
     */
