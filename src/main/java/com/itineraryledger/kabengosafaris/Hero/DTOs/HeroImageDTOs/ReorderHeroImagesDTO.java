...
/**
 * ReorderHeroImagesDTO - Data Transfer Object for reordering hero images
 *
 * Used when the UI performs drag-and-drop reordering of images within a hero.
 * The order list should contain ALL image IDs in the new desired order.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ReorderHeroImagesDTO {

    /**
     * The hero ID (obfuscated) that the images belong to
     */
    ...
    public static class ImageOrderItem {
        ...
        private String imageId; // Obfuscated hero image ID
