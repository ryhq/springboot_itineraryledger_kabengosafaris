...
/**
 * SafariDocument Entity - Manages generated and uploaded documents for safaris
 *
 * Stores various document files related to safaris:
 ...
 */
@Entity
@Table(name = "safari_documents", indexes = {
    @Index(name = "idx_safari_document_safari_id", columnList = "safari_id"),
    @Index(name = "idx_safari_document_type", columnList = "document_type"),
    @Index(name = "idx_safari_document_is_active", columnList = "is_active"),
    @Index(name = "idx_safari_document_valid_from", columnList = "valid_from"),
    @Index(name = "idx_safari_document_valid_to", columnList = "valid_to"),
    @Index(name = "idx_safari_document_is_generated", columnList = "is_generated")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class SafariDocument {
    ...
    /**
     * Safari-specific document type enumeration
     */
    public enum DocumentType {
        QUOTATION("Quotation", "Price quotation for the safari"),
