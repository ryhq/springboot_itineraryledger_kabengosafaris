...
public class ParkActivityImageController {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.itineraryledger.kabengosafaris.ParkActivity.Repositories.ParkActivityImageRepository bulkFlagsRepository;
    ...
    public ResponseEntity<?> bulkFlags(
        ...
        return bulkFlags.apply("park activity image", bulkFlagsRepository, request, entity -> {
