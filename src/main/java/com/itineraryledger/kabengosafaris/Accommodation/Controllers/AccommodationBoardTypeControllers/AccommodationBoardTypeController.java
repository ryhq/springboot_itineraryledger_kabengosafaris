...
public class AccommodationBoardTypeController {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.itineraryledger.kabengosafaris.Accommodation.Repositories.AccommodationBoardTypeRepository bulkFlagsRepository;
    ...
    public ResponseEntity<?> bulkFlags(
        ...
        return bulkFlags.apply("board type", bulkFlagsRepository, request, entity -> {
