...
/**
 * Entity class to store Image Configuration settings in the database.
 * This allows dynamic configuration changes without restarting the application.
 *
 * Manages settings for:
 * - Image upload enabled/disabled
 * - Maximum file size
 * - Allowed file formats
 */
@Entity
@Table(name = "image_settings", uniqueConstraints = {
...
public class ImageSetting {
    ...
    /**
     * Setting key (e.g., 'image.upload.enabled', 'image.upload.max.file.size')
     */
    ...
    /**
     * Categories for organizing image settings
     */
    public enum Category {
        UPLOAD("Image Upload Settings");
