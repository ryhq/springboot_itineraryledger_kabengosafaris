...
public class ParkActivityDocumentController {
    ...
    @org.springframework.beans.factory.annotation.Autowired
    private com.itineraryledger.kabengosafaris.ParkActivity.Repositories.ParkActivityDocumentRepository bulkFlagsRepository;
    ...
    public ResponseEntity<?> bulkFlags(
        ...
        return bulkFlags.apply("park activity document", bulkFlagsRepository, request, entity -> {
